...
export default function JobActions({ job }: JobActionsProps) {
    ...
    if (!job) {
        ...
        return <div className="flex items-center justify-end gap-1 h-9 w-[60px]"></div>;
    }
    // --- End Base Check ---
    ...
    return (
        <>
            {/* --- Parent Flex Container (Unchanged) --- */}
            <div className="flex items-center justify-between gap-1 w-full">
                ...
                <div className="flex items-center gap-1">
                    ...
                    {/* --- SWAPPED ORDER: Logs Button FIRST --- */}
                    ...
                    {/* --- SWAPPED ORDER: Re-stage Button SECOND --- */}
                     {canRerun && (
                ...
                {/* --- More Actions Dropdown (Pushed to Right - Unchanged) --- */}
